...
public class agechange extends ActionBarActivity {
    NumberPicker np = null;
    userDetail user=null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_agechange);
        //////////////
    ...
    private View.OnClickListener music1 = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            userDetail user =new userDetail(agechange.this);
            user.edit("age",newweight);
            /*
            * userDetail
            *
            */
