...
public class map extends Fragment {
    ...
    */
    ...
    public void screenshot(){
        Bitmap mCapture = CaptureScreeUtil.capture2(webview, 500, 500, true, Bitmap.Config.ARGB_8888);//CaptureScreeUtil.capture2(mCaptureWidth, mCaptureHeight, myWebView);
