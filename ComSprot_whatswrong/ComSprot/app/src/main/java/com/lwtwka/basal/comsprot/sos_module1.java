 ...
 */
public class sos_module1 extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //sos_module1_adapter adapter=new sos_module1_adapter(getActivity(),10);
        if(!location[0].equals("notyet")) {
            HAHA = new jsontask(L, 1, getActivity(), view);
    ...
    public void onDestroyView() {
        ...
        Log.v("close", "sos_module1 onDestroyView");
        if(HAHA!=null) {
            HAHA.cancel(true);
            HAHA = null;
        }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.v("close", "sos_module1 onDestroy");    }

    @Override
    public void onDetach() {
        super.onDetach();
        Log.v("close", "sos_module1 onDetach");
    }
    private View.OnClickListener goallmap = new View.OnClickListener() {
        public void onClick(View v) {
            ArrayList<ArrayList<String>> data=((sos_module1_adapter)(L.getAdapter())).data;
