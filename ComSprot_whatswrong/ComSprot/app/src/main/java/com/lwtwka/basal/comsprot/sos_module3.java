 ...
 */
public class sos_module3 extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //   sos_module3_adapter adapter=new sos_module3_adapter(getActivity(),10);
/*
        new jsontask(L,3,getActivity(),view)
...
*/
        if(!location[0].equals("notyet")) {
            HAHA = new jsontask(L, 3, getActivity(), view);
    ...
    public void onDestroyView() {
        ...
        Log.v("close", "sos_module3 onDestroyView");
        if(HAHA!=null) {
            HAHA.cancel(true);
            HAHA = null;
        }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.v("close", "sos_module3 onDestroy");    }

    @Override
    public void onDetach() {
        super.onDetach();
        Log.v("close", "sos_module3 onDetach");
    }
    private View.OnClickListener goallmap = new View.OnClickListener() {
        public void onClick(View v) {
            ArrayList<ArrayList<String>> data=((sos_module3_adapter)(L.getAdapter())).data;
