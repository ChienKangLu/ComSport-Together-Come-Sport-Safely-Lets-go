...
public class heightchange extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heightchange);
        //////////////
        ...
        np2.setMaxValue(99);
        np2.setValue(cm);
        set_numberpicker_text_colour(np2);
        setDividerColor(np2);
    ...
    private View.OnClickListener music1 = new View.OnClickListener() {
        public void onClick(View v) {
            String newheight=""+np.getValue()+np2.getValue();
            userDetail user =new userDetail(heightchange.this);
            user.edit("height",newheight);
            /*
            * userDetail
            * */
           // Toast.makeText(v.getContext(),""+np.getValue()+np2.getValue(),Toast.LENGTH_LONG).show();
            onBackPressed();
        }
    };
